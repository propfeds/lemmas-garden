...
const plantData = {
    ...
    ginger: {
        ...
        system: new LSystem('\\[A(0.2, 3)]-(90)R(-2)', [
            ...
            'L(r): r<1 = L(r+0.05)',
            'R(s): s<8 = R(s+0.5)',
            'R(s) = R(s, 0)&(15)R(0): 0.375; [&R(0)]^(15)R(s): 0.25; R(s, 0)[+(90)A(0.2, 3)]: 0.125; R(s, 1)[&(30)R(0)][^R(-1)]: 0.125; R(s+2, 1): 0.125',
            ...
            '~> r(s) = {F(s/10)o(s/3.2, s/5)o(s/2.4, s/5)o(s/3, s/5)o(s/2.8, s/5)F(s/10)}',
