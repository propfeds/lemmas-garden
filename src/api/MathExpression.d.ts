...
export class MathExpression {
     ...
     */
    static parse(expression: string): MathExpression;
    /**
     ...
     */
    static deserialize(state: string): MathExpression;
    /**
     ...
     */
    evaluate(getVariable?: (arg0: string) => BigNumber): BigNumber;
    /**
